package hashengineering.anime.crypto;
...
public class Hash9 {
    ...
    public static byte[] animeDigest(byte[] input, int offset, int length)
    {
        ...
        return animeDigest(buf);
    }

    public static byte[] animeDigest(byte[] input) {
        ...
        try {
            ...
            //log.info("Anime Hash time: {} ms per block", time);
        }
    }
