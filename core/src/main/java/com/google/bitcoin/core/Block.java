...
import static hashengineering.anime.crypto.Hash9.animeDigest;
...
public class Block extends Message {
    ...
    private void parseHeader() throws ProtocolException {
        ...
        hash = new Sha256Hash(Utils.reverseBytes(/*Utils.doubleDigest*/animeDigest(bytes, offset, cursor)));
    ...
    private Sha256Hash calculateHash() {
        try {
            ...
            writeHeader(bos);
            return new Sha256Hash(Utils.reverseBytes(animeDigest(bos.toByteArray())));
        } catch (IOException e) {
    ...
    /*private Sha256Hash calculateAnimeHash() {
        try {
            ByteArrayOutputStream bos = new UnsafeByteArrayOutputStream(HEADER_SIZE);
            writeHeader(bos);
            return new Sha256Hash(Utils.reverseBytes(CoinDefinition.animeDigest(bos.toByteArray())));
        } catch (IOException e) {
            throw new RuntimeException(e); // Cannot happen.
        }
    }*/
    ...
    /*public String getAnimeHashAsString() {
        return getAnimeHash().toString();
    }*/
    ...
    /*public Sha256Hash getAnimeHash() {
        if (animeHash == null)
            animeHash = calculateAnimeHash();
        return animeHash;
    }*/
